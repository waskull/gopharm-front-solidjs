    ...
    return (
        <>
            {id ? (
                ...
                (
                    <a ref={btnEl} onClick={() => setOpen(true)} class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition duration-150 ease-in-out cursor-pointer">Agregar usuario</a >
                )}
            <Dismiss
                menuButton={btnEl}
                open={open}
                ...
                >
                    <div ref={dialogEl} class="modal" role="dialog" aria-modal="true" tabindex="-1">
                        <div class="relative bg-gray-100 rounded-lg shadow-sm dark:bg-gray-700">
                            ...
                            <UserForm id={id} onClickClose={onClickClose} />
